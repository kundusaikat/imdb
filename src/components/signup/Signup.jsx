    ...
    <div className="mdiv">
      <div className="ldiv">
        ...
        <div>
          ...
          <div className="signinmethod">
            <div className="imgd">
              <img src="https://ia.media-imdb.com/images/M/MV5BODc4MTA3NjkzNl5BMl5BcG5nXkFtZTgwMDg0MzQ2OTE@._V1_.png"></img>
            </div>
            <div className="h2">
